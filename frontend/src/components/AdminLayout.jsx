...
import { 
  ...
  FiDollarSign, FiBarChart2, FiSettings, FiLogOut, FiMenu, FiX, FiUserCheck, FiTruck 
} from 'react-icons/fi';
...
const sidebarLinks = [
  ...
  { path: '/admin/delivery-persons', icon: FiTruck, label: 'Delivery Persons' },
  { path: '/admin/delivery-orders', icon: FiTruck, label: 'Delivery Management' },
