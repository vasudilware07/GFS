...
import { FiMail, FiLock, FiEye, FiEyeOff, FiTruck, FiUser } from 'react-icons/fi';
...
export default function Login() {
  ...
  const [loginType, setLoginType] = useState('user'); // 'user' or 'delivery'
    ...
    <div className="min-h-[80vh] flex items-center justify-center bg-gray-50 px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          {/* Only show Google login and Register for regular users */}
          {loginType === 'user' && (
            <>
              {/* Divider */}
          ...
          {loginType === 'delivery' && (
            <p className="mt-6 text-center text-sm text-gray-500">
              Delivery partner account? Contact admin for credentials.
            </p>
          )}
        </div>
      </div>
